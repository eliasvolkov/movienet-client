...
const data: any = [
    ...
    {
        adult: false,
        backdrop_path: '/uTNLQuDxwX6C5EpHPGGLICXSbXC.jpg',
        genre_ids: [28, 53, 878],
        id: 577922,
        original_language: 'en',
    ...
    {
        adult: false,
        backdrop_path: '/cGpSa0jmJ2GJkjU81hw1B8SBL25.jpg',
        genre_ids: [28, 53],
        id: 524047,
        original_language: 'en',
    ...
    {
        adult: false,
        backdrop_path: '/ppQo2xyDnZtNJyJmHmmL4zTgl6Q.jpg',
    ...
    {
        adult: false,
        backdrop_path: '/voFNQchCQFzBIBoFgsOdA1iSMNP.jpg',
        genre_ids: [28, 14, 878],
        id: 590706,
        original_language: 'en',
    ...
    {
        adult: false,
        backdrop_path: '/xQByrOZy064PNEz6GSw8jiSDvhB.jpg',
        genre_ids: [28, 35, 14],
        id: 602211,
        original_language: 'en',
    ...
    {
        adult: false,
        backdrop_path: '/cutQfIq4SughyhEXvzGHKl3ResO.jpg',
        genre_ids: [14, 28, 12],
        id: 464052,
        original_language: 'en',
    ...
    {
        adult: false,
        backdrop_path: '/27BnREBR5rcMrUVUhV5bTXlcCym.jpg',
        genre_ids: [10770, 53],
        id: 648371,
        original_language: 'en',
    ...
    {
        adult: false,
        backdrop_path: '/81iMiiaEZSt2ttcMjAHpYfrtDg2.jpg',
        genre_ids: [35, 80, 53],
        id: 765123,
    ...
    {
        adult: false,
        backdrop_path: '/9P2s4iRmuQUI8olLhrClxkOwu6R.jpg',
        genre_ids: [18, 53],
        id: 441282,
        original_language: 'en',
    ...
    {
        adult: false,
        backdrop_path: '/ak1ItacOtaS641da1zxsW8gUQag.jpg',
        genre_ids: [12, 14, 28],
        id: 634244,
        original_language: 'en',
    ...
    {
        adult: false,
        backdrop_path: '/jRp9gWTqVixyfUAncW4vZm2qZZZ.jpg',
        genre_ids: [36, 28, 12],
        id: 635237,
        original_language: 'en',
...
export const HomePage = () => {
    return (
        <Wrapper>
            <Header />
            <Image />
            <SimpleSlider data={data} rowTitle="Related" />
            <SimpleSlider data={data} rowTitle="Coming Soon" />
            <SimpleSlider data={data} rowTitle="Top Rated" />
        </Wrapper>
    );
};
